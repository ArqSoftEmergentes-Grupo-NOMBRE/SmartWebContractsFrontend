<template>
  ...
  >
    ...
    <div class="space-y-5">
      ...
      <InputText placeholder="Método de pago"     v-model="form.method"   class="w-full h-11 bg-transparent border border-neutral-500 rounded-md px-3 text-white"/>
      <InputText placeholder="Billetera asociada" v-model="form.wallet"   class="w-full h-11 bg-transparent border border-neutral-500 rounded-md px-3 text-white"/>
      <InputText placeholder="Enlace de LinkedIn" v-model="form.linkedin" class="w-full h-11 bg-transparent border border-neutral-500 rounded-md px-3 text-white"/>
    </div>
